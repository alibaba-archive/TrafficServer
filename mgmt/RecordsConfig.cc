...
RecordElement RecordsConfig[] = {
  ...
  ,
  {RECT_CONFIG, "proxy.config.http.client_max_connections", RECD_INT, "0", RECU_DYNAMIC, RR_NULL, RECC_STR, "^[0-9]+$", RECA_NULL}
  ,
  ...
  ,
  {RECT_CONFIG, "proxy.config.net.max_accept", RECD_INT, "0", RECU_NULL, RR_NULL, RECC_NULL, NULL, RECA_NULL}
  ,
  {RECT_CONFIG, "proxy.config.net.max_active_client", RECD_INT, "0", RECU_NULL, RR_NULL, RECC_NULL, NULL, RECA_NULL}
  ,
  ...
  ,
  {RECT_CONFIG, "proxy.config.cache.max_readers_while_writer", RECD_INT, "10", RECU_DYNAMIC, RR_NULL, RECC_NULL, NULL, RECA_NULL}
  ,

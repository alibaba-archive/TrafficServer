...
Name:		trafficserver
Version:	3.2.0
Release:	3%(echo ${RELEASE:+.${RELEASE}})%{?dist}
License:	ASL 2.0
...
./configure --enable-layout=Gentoo --libdir=%{_libdir}/trafficserver --with-tcl=%{_libdir} --with-user=ats --with-group=ats  --enable-reclaimable-freelist
make %{?_smp_mflags}

...
public:
  ...
  inkcoreapi virtual int marshal_client_req_proto_type(char *); // INT
  ...
  static int unmarshal_client_req_proto_type(char **buf, char *dest, int len, Ptr<LogFieldAliasMap> map);

...
void
spdy_on_stream_close_callback(spdylay_session *session, int32_t stream_id,
...
spdy_get_credential_proof(spdylay_session *session,
                          const spdylay_origin *origin, uint8_t *proof,
...
ssize_t
spdy_get_credential_cert(spdylay_session *session, const spdylay_origin *origin,
                         size_t idx, uint8_t *cert, size_t certlen,
                         void *user_data)
{
  //TODO
  return 0;
...
void
spdy_on_request_recv_callback(spdylay_session *session, int32_t stream_id,
                              void *user_data)
{
  //TODO
  return;
